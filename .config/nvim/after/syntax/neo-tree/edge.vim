...
if index(g:edge_loaded_file_types, 'neo-tree') ==# -1
    call add(g:edge_loaded_file_types, 'neo-tree')
else
    finish
endif
...
if &background ==# 'light'
  call edge#highlight('NeoTreeCursorLine', s:palette.none, s:palette.bg0)
endif
" syn_end
